...
For basal data:  
![](./BasalData.png){width=50%}<br/>
For Dist data:  
![](./Dist Data.JPG){width=50%}<br/>
For Elev data:  
![](./Elev Data.JPG){width=50%}<br/>
For Heart data:  
![](./Heart Data.JPG){width=50%}<br/>
For Steps data:  
![](./Steps Data.JPG){width=50%}<br/>
