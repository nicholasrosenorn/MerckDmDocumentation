...
|                    	| Flights Climbed                   	| x           	| x              	|
|                    	| Elevation                         	| x           	| x              	|
|                    	| Time in different activity levels 	| x           	| 3rd party apps 	|
|                    	| Calories burned                   	| x           	| x              	|
| Sleep              	| Asleep vs Awake                   	| x           	| x              	|
|                    	| Stages                            	| x           	| NA             	|
| Heart Rate         	| Time in different heart rates     	| x           	| x              	|
|                    	| Resting heart rate                	| x           	| x              	|
|                    	| Walking heart rate                	| x           	| x              	|
...
|            	| Flights Climbed                   	| x     	|            	|         	|          	|
|            	| Elevation                         	| x     	|            	|         	|          	|
|            	| Time in different activity levels 	| x     	| x          	|         	|          	|
|            	| Calories burned                   	| x     	| x          	|         	|          	|
| Sleep      	| Asleep vs Awake                   	| x     	| x          	| x       	| x        	|
|            	| Stages                            	| x     	| x          	|         	|          	|
| Heart Rate 	| Time in different heart rates     	| x     	| x          	|         	| x        	|
|            	| Resting heart rate                	| x     	| x          	|         	| x        	|
|            	| Walking heart rate                	| x     	| x          	|         	| x        	|
...
Additionally, we also import BlockingScheduler because it will help us 
...
We initialize the Blocking Scheduler so that we can schedule our cronjob at the specified time we want, either at specific hours of the day or we can run the job at every specified interval ie: (in seconds). 
